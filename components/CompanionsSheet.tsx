...
function createStyles(C: ReturnType<typeof useColors>) {
  return StyleSheet.create({
    ...
    card: {
      ...
      borderWidth: 1, borderColor: C.border, padding: 10, gap: 3, position: "relative",
    },
    cardActive: { borderColor: C.primary, backgroundColor: C.surface2 },
    cardIcon: { width: 36, height: 36, borderRadius: 10, alignItems: "center", justifyContent: "center" },
    cardName: { color: C.text, fontSize: 13, fontFamily: "Inter_600SemiBold" },
    cardDesc: { color: C.textSecondary, fontSize: 11, fontFamily: "Inter_400Regular", lineHeight: 15 },
    cardFooter: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginTop: 2, flexWrap: "wrap", gap: 3 },
